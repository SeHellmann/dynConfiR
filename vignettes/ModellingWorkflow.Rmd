...
vignette: >
  %\VignetteIndexEntry{Illustration of the workflow for a modelling study using dynConfiR}
...
## Workflow of model comparison studies
...
load("saved_parfits_restricted.RData")
